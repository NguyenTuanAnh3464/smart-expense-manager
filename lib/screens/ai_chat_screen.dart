...
class _AIChatScreenState extends State<AIChatScreen> {
  final LocalAIService aiService = LocalAIService();
  ...
  void openBankImageScanner() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const BankImageUploadScreen()),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: "Quét ảnh giao dịch ngân hàng",
          ...
          Expanded(
            child: messages.isEmpty
                ? _EmptyChatState(
                    ...
                    onScanBankImage: openBankImageScanner,
                  )
                : ListView.builder(
...
class _EmptyChatState extends StatelessWidget {
  ...
  final VoidCallback onScanBankImage;

  const _EmptyChatState({
    required this.suggestions,
    required this.onTapSuggestion,
    required this.onScanBankImage,
  });
      ...
      children: [
        AppPanel(
          child: Column(
            ...
            children: [
              ...
              Text(
                "Trợ lý dùng dữ liệu tài chính trong app để trả lời bằng logic local, không gọi API bên ngoài.",
        ...
        Card(
          child: ListTile(
            ...
            title: const Text(
              "Quét ảnh giao dịch ngân hàng",
              style: TextStyle(fontWeight: FontWeight.w700),
            ),
            subtitle: const Text(
              "Tải ảnh thông báo ngân hàng để OCR local tạo giao dịch",
            ),
            trailing: const Icon(Icons.chevron_right),
            onTap: onScanBankImage,
          ),
        ),
      ],
    );
